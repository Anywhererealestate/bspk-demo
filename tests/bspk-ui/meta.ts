...
export const componentsMeta: ComponentMeta[] = [
  {
    ...
    css: '\n  display: flex;\n',
    dependencies: [],
    modified: '2025-05-07T21:43:43.481Z',
  ...
  },
  {
    ...
    css: '\n  display: flex;\n',
    dependencies: [],
    modified: '2025-05-07T21:43:43.482Z',
    hasTouchTarget: false,
  },
  {
    description: 'Component description coming soon.',
  ...
  },
  {
    ...
    css: '\n  display: flex;\n',
    dependencies: [],
    modified: '2025-05-07T21:43:43.483Z',
    hasTouchTarget: false,
  },
  {
    description:
  ...
  },
  {
    ...
    dependencies: ['Txt'],
    modified: '2025-05-07T21:43:43.484Z',
    hasTouchTarget: false,
  },
  {
  ...
  },
  {
    ...
    css: '\n  display: flex;\n',
    dependencies: [],
    modified: '2025-05-07T21:43:43.485Z',
    hasTouchTarget: false,
  },
  {
    description: 'Component description coming soon.',
  ...
  },
  {
    ...
    modified: '2025-05-07T21:43:43.486Z',
    hasTouchTarget: false,
  },
  {
  ...
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:25.001Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:26.036Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:32.633Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:39.153Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:45.224Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:51.386Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:46:57.312Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:47:03.440Z',
    hasTouchTarget: false,
  },
  {
    ...
    css: '',
    dependencies: [],
    modified: '2025-05-07T21:47:09.500Z',
    hasTouchTarget: false,
  },
  {
    description:
    ...
    dependencies: [],
    modified: '2025-05-07T21:43:43.487Z',
    hasTouchTarget: false,
  },
  {
    description:
  ...
  },
  {
    ...
    dependencies: ['Portal'],
    modified: '2025-05-07T21:43:43.488Z',
    hasTouchTarget: false,
  },
  {
    description: 'Component description coming soon.',
    ...
    properties: [
      {
        name: 'count',
        description:
          "The content of the badge. If larger than 99, the badge will display '99+'. If null or undefined, the badge will be\nhidden.",
        type: 'number',
      },
      {
        name: 'size',
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        required: false,
        description:
          'Change the color of the link to a subtle color. This is useful for links that are not primary actions, for example\nfooter menus.',
        default: 'default',
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        default: 'small',
        type: ['x-small', 'small', 'medium', 'large', 'x-large', 'xx-large', 'xxx-large', 'xxxx-large', 'xxxxx-large'],
        options: [
          'x-small',
          'small',
          'medium',
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        required: false,
        description:
          "The width of the options. If set to 'fill', the options will fill the width of the container. If set to 'hug', the\noptions will be as wide as their content.",
        default: 'hug',
        type: ['fill', 'hug'],
        options: ['fill', 'hug'],
      },
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        required: false,
        description:
          "When width is 'hug' this determines if the trailing underline should be showing. When width is 'fill' this property\nisn't applicable.",
        default: false,
        type: 'boolean',
      },
    ],
  ...
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        required: false,
        description:
          'The minimum number of rows that the textarea should have. If set the textarea will automatically grow and shrink to\nfit the content.',
        type: 'number',
        minimum: 3,
      },
      {
        ...
        required: false,
        description:
          'The maximum number of rows that the textarea should have. If set the textarea will automatically grow and shrink to\nfit the content.',
        type: 'number',
        maximum: 10,
      },
    ],
