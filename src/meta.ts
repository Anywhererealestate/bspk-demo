...
export const componentsMeta: ComponentMeta[] = [
  {
    "description": "An avatar is a visual representation of a user or entity. It can be used to display an initials, icon, image, or an overflowCount.",
    "file": "/Avatar.tsx",
    "name": "Avatar",
    "slug": "avatar",
    "dependencies": [],
  ...
  {
    "description": "Visual indicator for new items within a parent page represented with a numerical count of new items.",
    "file": "/Badge.tsx",
    "name": "Badge",
    "slug": "badge",
    "dependencies": [],
  ...
  {
    "description": "A visual and contextual message used to communicate an important message or notification to users relating to a status or the body content of a page.",
    "file": "/BannerAlert.tsx",
    "name": "BannerAlert",
    "slug": "banner-alert",
    "dependencies": [],
    "modified": "2025-05-22T00:29:07.785Z",
  ...
  {
    "description": "A clickable component that allows users to perform an action, make a choice or trigger a change in state.",
    "file": "/Button.tsx",
    "name": "Button",
    "slug": "button",
    "dependencies": [
  ...
  {
    "description": "Cards are often rectangular and contain various content, such as text, images, icons, multimedia, and interactive elements.\n\nThey are similar in size and shape to playing cards and are intended to encourage users to click or tap to view more details.",
    "file": "/Card.tsx",
    "name": "Card",
    "slug": "card",
    "dependencies": [],
  ...
  {
    "description": "A control that allows users to choose one or more items from a list or turn an feature on or off. This is the base element and if used directly you must wrap it with a label. This will more often be used in the CheckboxOption or CheckboxGroup component.",
    "file": "/Checkbox.tsx",
    "name": "Checkbox",
    "slug": "checkbox",
    "dependencies": [],
  ...
  {
    "description": "A group of checkboxes that allows users to choose one or more items from a list or turn an feature on or off.",
  ...
  {
    "description": "A control that allows users to choose one or more items from a list or turn an feature on or off.",
  ...
  {
    "description": "Dialogs display important information that users need to acknowledge. They appear over the interface and block further interactions until an action is selected.",
    "file": "/Dialog.tsx",
    "name": "Dialog",
    "slug": "dialog",
    "dependencies": [
  ...
  {
    "description": "Horizontal thin lines that separates grouped content in a list or other containers with an optional section/group label.\n\nVertical thin lines that separates grouped content or other visual elements within a container.",
    "file": "/Divider.tsx",
    "name": "Divider",
    "slug": "divider",
    "dependencies": [],
  ...
  {
    "description": "A button that highlights a primary action that is elevated above the body content of a page; normally fixed to the bottom right of a screen.",
    "file": "/Fab.tsx",
    "name": "Fab",
    "slug": "fab",
    "dependencies": [
  ...
  {
    "description": "Inline alerts provide contextual feedback messages for typical user actions with a handful of available and flexible alert messages.",
  ...
  {
    "description": "A container housing a simple list of options presented to the user to select one option at a time.",
    "file": "/Menu.tsx",
    "name": "Menu",
    "slug": "menu",
    "dependencies": [
  ...
  {
    "description": "Modals display important information that users need to acknowledge. They appear over the interface and block further interactions until an action is selected. Modal is a wrapper around the Dialog component that provides a header and footer for the dialog.\n\nTODO: Add support for custom header and footer",
    "file": "/Modal.tsx",
    "name": "Modal",
    "slug": "modal",
    "dependencies": [
  ...
  {
    "description": "A input element that allows users to either input a numerical value or singularly increase or decrease the values by pressing the (+) or (-).\n\nThis component takes properties from the FormField and NumberInput components.",
  ...
  {
    "description": "Utility component to render children in the portals container provided by the BaseProvider.\n\nInitial SRR is supported.",
    "file": "/Portal.tsx",
    "name": "Portal",
    "slug": "portal",
    "dependencies": [],
  ...
  {
    "description": "A progress bar is a horizontal visual indicator that let’s the user know the progression of a task or operation occurring in the background.",
  ...
  {
    "description": "Rotating circle or pill that indicates the status or state of completion for a process that’s part of a user flow.",
  ...
  {
    "description": "A progress stepper is a horizontal visual indicator that let’s the user know the progression of the current process.",
  ...
  {
    "description": "A round control that allows user to choose one option from a set. This is the base element and if used directly you must wrap it with a label. This will more often be used in the RadioOption or RadioGroup component.",
    "file": "/Radio.tsx",
    "name": "Radio",
    "slug": "radio",
    "dependencies": [],
  ...
  {
    "description": "A group of radios that allows users to choose one or more items from a list or turn an feature on or off.",
    "file": "/RadioGroup.tsx",
    "name": "RadioGroup",
    "slug": "radio-group",
    "dependencies": [
  ...
  {
    "description": "A group of switches that allows users to choose one or more items from a list or turn an feature on or off.",
  ...
  {
    "description": "A text input that allows users to enter text, numbers or symbols in a singular line.\n\nThis component takes properties from the FormField and TextInput components.",
    "file": "/TextField.tsx",
    "name": "TextField",
    "slug": "text-field",
    "dependencies": [
  ...
  {
    "description": "A text input that allows users to enter text, numbers or symbols in a singular line. This is the base element and is not intended to be used directly. Use the TextField component.",
    "file": "/TextInput.tsx",
    "name": "TextInput",
    "slug": "text-input",
    "dependencies": [],
...
export const utilitiesMeta: UtilityMeta[] = [
  ...
  {
    "description": "This hook provides keyboard navigation for a list of elements. Used inside the Dropdown component.",
...
export const typesMeta: TypeMeta[] = [
  ...
  },
  {
    ...
    "properties": [
      {
        "name": "count",
        "description": "The content of the badge. If larger than 99, the badge will display '99+'. If null or undefined, the badge will\nbe hidden.",
        "type": "number"
      },
      {
        "name": "size",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "onClose",
        "required": false,
        "description": "The function to call when the banner alert is closed. If not included the close button will not be displayed.",
        "type": "() => void"
      },
      {
        "name": "header",
      ...
      },
      {
        "name": "callToAction",
        "required": false,
        "description": "This property may be undefined or an object containing required CallToActionButton properties.",
  ...
  },
  {
    ...
    "properties": [
      {
        "name": "disabled",
        "description": "Determines if the element is [disabled](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/disabled).",
        "default": false,
        "type": "boolean"
      },
      {
      ...
      {
        "name": "showLabel",
        "description": "Shows the button label. When label isn't showing it is used in a tooltip and as the aria-label prop.",
        "default": true,
        "type": "boolean"
      },
      {
    ...
    "properties": [
      {
        "name": "name",
        "required": true,
        "description": "The [name](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#name) of the control.",
        "type": "string"
      },
      {
        "name": "value",
  ...
  },
  {
    ...
    "properties": [
      ...
      {
        "name": "readOnly",
        "description": "Determines if the element is [readonly](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/readonly).",
        "default": false,
        "type": "boolean"
      }
    ],
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "required",
        "required": false,
        "description": "Determines if the element is [required](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/required).",
        "default": false,
        "type": "boolean"
      },
      {
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "placement",
        "required": false,
        "description": "The placement of the dropdown menu. Will be ignored if the menu is too close to the edge of the screen.",
        "default": "bottom",
        "type": [
          "bottom",
          "top"
  ...
  },
  {
    ...
    "properties": [
      ...
      {
        "name": "renderListItem",
        "description": "A function which given data about the list item returns additional list item props used to render the list items.",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "children",
        "required": true,
        "description": "The children of the form field. This should be a control such as TextInput, Dropdown, DatePicker, or TimePicker.",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "href",
        "required": true,
        "description": "The [href](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/a#href) of the link.",
        "type": "string"
      },
      {
        "name": "size",
      ...
      },
      {
        "name": "variant",
        "required": false,
        "description": "Change the color of the link to a subtle color. This is useful for links that are not primary actions, for\nexample footer menus.",
        "default": "default",
        "type": [
          "default",
          "subtle",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "max",
        "required": false,
        "description": "Defines the [maximum](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/max) value that is accepted.",
        "type": "number"
      },
      {
        "name": "min",
        "required": false,
        "description": "Defines the [minimum](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/min) value that is accepted.",
        "type": "number"
      }
    ],
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "autoComplete",
        "required": false,
        "description": "Specifies if user agent has any permission to provide automated assistance in filling out form field values.\nhttps://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete",
        "default": "off"
      },
      {
        "name": "placeholder",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "variant",
        "required": false,
        "description": "The variant of the progress bar. Can be either horizontal, vertical, or widget.\n\nWhen on small width screens, the default will automatically switch to widget.",
        "default": "horizontal",
        "type": [
          "horizontal",
          "vertical",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "width",
        "required": false,
        "description": "The width of the options. If set to 'fill', the options will fill the width of the container. If set to 'hug',\nthe options will be as wide as their content.",
        "default": "hug",
        "type": [
          "fill",
          "hug"
      ...
      },
      {
        "name": "showLabels",
        "required": false,
        "description": "Determines if the labels of the options should be displayed. If icons are not provided for every option this is\nignored and labels are shown.",
        "default": true,
        "type": "boolean"
      }
    ],
  ...
  },
  {
    ...
    "properties": [
      {
        "name": "variant",
        "description": "The text variant of the skeleton. If 'other' skeleton will expand to size of nearest relative positioned parent.",
        "default": "other",
        "type": [
          "body-base",
          "body-large",
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "width",
        "required": false,
        "description": "When 'fill' the options will fill the width of the container. When 'hug', the options will be as wide as their\ncontent.",
        "default": "hug",
        "type": [
          "fill",
          "hug"
      ...
      },
      {
        "name": "showTrail",
        "required": false,
        "description": "When width is 'hug' this determines if the trailing underline should be showing. When width is 'fill' this\nproperty isn't applicable.",
        "default": false,
        "type": "boolean"
      }
    ],
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "width",
        "required": false,
        "description": "The width of the column. This is used to set the width of the column.\n\nUsed to set the value of\n[grid-template-columns](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns)",
        "default": "1fr",
        "type": "string"
      }
    ],
  ...
  },
  {
    ...
    "properties": [
      ...
      },
      {
        "name": "minRows",
        "required": false,
        "description": "The minimum number of rows that the textarea should have. If set the textarea will automatically grow and shrink\nto fit the content.",
        "type": "number",
        "minimum": 3
      },
      {
        "name": "maxRows",
        "required": false,
        "description": "The maximum number of rows that the textarea should have. If set the textarea will automatically grow and shrink\nto fit the content.",
        "type": "number",
        "maximum": 10
      }
    ],
...
export type MetaTypeName = 'AvatarProps' | 'BadgeProps' | 'BannerAlertProps' | 'ButtonProps' | 'CallToActionButton' | 'CardProps' | 'CheckboxGroupOption' | 'CheckboxGroupProps' | 'CheckboxOptionProps' | 'CheckboxProps' | 'ChipProps' | 'CommonProps<"active"|"disabled"|"readOnly">' | 'CommonProps<"aria-label">' | 'CommonProps<"disabled">' | 'CommonProps<"disabled"|"onClick">' | 'CommonProps<"id">' | 'CommonProps<"id"|"disabled">' | 'CommonProps<"invalid"|"disabled"|"readOnly">' | 'CommonProps<"name"|"aria-label">' | 'CommonProps<"name"|"id"|"invalid"|"disabled"|"size"|"aria-label"|"readOnly">' | 'CommonProps<"name"|"invalid"|"disabled"|"aria-label",HTMLInputElement>' | 'CommonProps<"name"|"invalid"|"disabled"|"aria-label",T>' | 'CommonProps<"name"|"required"|"id"|"value"|"invalid"|"disabled"|"size"|"aria-label"|"readOnly">' | 'CommonProps<"name"|"value">' | 'CommonProps<"name"|"value"|"disabled"|"aria-label"|"onClick">' | 'CommonProps<"required"|"errorMessage">' | 'CommonProps<"required"|"id"|"invalid"|"disabled"|"aria-label"|"readOnly">' | 'CommonPropsLibrary' | 'DialogProps' | 'DividerProps' | 'DropdownFieldProps' | 'DropdownOption' | 'DropdownProps' | 'ElementProps' | 'EmptyStateProps' | 'FabProps' | 'FieldControlProps' | 'FormFieldProps' | 'ImgProps' | 'InlineAlertProps' | 'LayoutProps' | 'LinkProps' | 'ListItemProps' | 'M' | 'MenuButtonProps' | 'MenuItem' | 'MenuProps' | 'ModalProps' | 'NavOption' | 'NumberFieldProps' | 'NumberInputProps' | 'Pick<ButtonProps<As>,"icon"|"onClick"|"as"|"showLabel"|"toolTip">' | 'Pick<CheckboxProps,"name"|"value"|"invalid"|"disabled"|"onChange"|"checked"|"indeterminate">' | 'Pick<DropdownProps,"name"|"value"|"disabled"|"options"|"size"|"onChange"|"placeholder"|"readOnly"|"placement"|"itemCount">' | 'Pick<FormFieldProps,"label"|"errorMessage"|"helperText"|"controlId">' | 'Pick<FormFieldProps,"label"|"errorMessage"|"helperText"|"labelTrailing"|"controlId">' | 'Pick<FormFieldProps,"required"|"label"|"errorMessage"|"helperText"|"labelTrailing"|"controlId">' | 'Pick<MenuProps,"itemCount"|"items"|"noResultsMessage">' | 'Pick<MenuProps<M>,"activeIndex"|"isMulti"|"selectedValues">' | 'Pick<MenuProps<O>,"onChange"|"isMulti"|"itemCount"|"renderListItem">' | 'Pick<NumberInputProps,"name"|"id"|"value"|"invalid"|"disabled"|"size"|"onChange"|"readOnly"|"centered">' | 'Pick<RadioProps,"name"|"value"|"invalid"|"disabled"|"onChange"|"checked">' | 'Pick<TextInputProps,"name"|"id"|"size"|"aria-label"|"placeholder"|"inputRef">' | 'Pick<TextInputProps,"name"|"required"|"type"|"value"|"invalid"|"disabled"|"size"|"onChange"|"autoComplete"|"placeholder"|"readOnly"|"leading"|"trailing"|"inputRef">' | 'Pick<ToggleControlProps<HTMLInputElement>,"value">' | 'Pick<ToggleOptionProps,"label"|"description">' | 'Pick<ToggleOptionProps,"label"|"size"|"description">' | 'PopoverProps' | 'PortalProps' | 'ProgressBarProps' | 'ProgressCircleProps' | 'ProgressionStepperBarProps' | 'ProgressionStepperItem' | 'ProgressionStepperProps' | 'RadioGroupOption' | 'RadioGroupProps' | 'RadioOptionProps' | 'RadioProps' | 'RenderListItemParams' | 'Required<CommonProps<"value",HTMLElement>>' | 'Required<CommonProps<"value">>' | 'Required<Pick<ButtonProps<As>,"label">>' | 'SearchBarProps' | 'SegmentedControlProps' | 'SegmentedToggleOption' | 'SkeletonProps' | 'SwitchGroupOption' | 'SwitchGroupProps' | 'SwitchOptionProps' | 'SwitchProps' | 'TabGroupOption' | 'TabGroupProps' | 'TableColumn' | 'TableProps' | 'TagProps' | 'TextareaFieldProps' | 'TextareaProps' | 'TextFieldProps' | 'TextInputProps' | 'ToggleControlProps' | 'ToggleOptionProps' | 'TooltipProps' | 'TopNavigationProps' | 'TxtProps';

export type MetaComponentName = 'Avatar' | 'Badge' | 'BannerAlert' | 'Button' | 'Card' | 'Checkbox' | 'CheckboxGroup' | 'CheckboxOption' | 'Chip' | 'Dialog' | 'Divider' | 'Dropdown' | 'DropdownField' | 'EmptyState' | 'Fab' | 'FormField' | 'Img' | 'InlineAlert' | 'Layout' | 'Link' | 'ListItem' | 'Menu' | 'MenuButton' | 'Modal' | 'NumberField' | 'NumberInput' | 'Popover' | 'Portal' | 'ProgressBar' | 'ProgressCircle' | 'ProgressionStepper' | 'ProgressionStepperBar' | 'Radio' | 'RadioGroup' | 'RadioOption' | 'SearchBar' | 'SegmentedControl' | 'Skeleton' | 'StylesProviderAnywhere' | 'StylesProviderBetterHomesGardens' | 'StylesProviderCartus' | 'StylesProviderCentury21' | 'StylesProviderColdwellBanker' | 'StylesProviderCorcoran' | 'StylesProviderDenaliBoss' | 'StylesProviderEra' | 'StylesProviderSothebys' | 'Switch' | 'SwitchGroup' | 'SwitchOption' | 'TabGroup' | 'Table' | 'Tag' | 'Textarea' | 'TextareaField' | 'TextField' | 'TextInput' | 'ToggleOption' | 'Tooltip' | 'TopNavigation' | 'Txt';