import{j as a,s as g}from"./index-BsfVAUQm.js";const l=document.createElement("style");l.appendChild(document.createTextNode(`[data-bspk=progression-stepper] {
  width: 100%;
...
`));document.head.appendChild(l);function b({steps:e=[],currentStep:d=0,variant:i="horizontal",...p}){const r=Math.max(0,Math.min(d,e.length+1));return e!=null&&e.length?a.jsxs("div",{...p,"data-bspk":"progression-stepper","data-variant":i,children:[i==="widget"&&a.jsxs("label",{children:[a.jsx("span",{"data-title":!0,children:e[Math.max(0,Math.min(r-1,e.length-1))].name}),a.jsx("span",{"data-subtitle":!0,children:r>e.length?"Completed":a.jsxs(a.Fragment,{children:["Step ",r," of ",e.length]})})]}),a.jsx("ol",{children:e.map(({name:c,subtext:o},s)=>{const n=s+1;let t="incomplete";return r>n?t="complete":r===n&&(t="current"),a.jsxs("li",{"aria-current":t==="current"?"step":void 0,"data-status":t,"data-step":n,children:[a.jsxs("span",{"data-line-circle":!0,children:[a.jsx("span",{"data-line":"before"}),a.jsx("span",{"data-circle":!0,children:t==="complete"?a.jsx(g,{"aria-hidden":!0}):(i!=="widget"||t==="current")&&a.jsx("span",{children:n})}),a.jsx("span",{"data-line":"after"})]}),i!=="widget"&&a.jsxs("span",{"data-content":!0,children:[a.jsx("span",{"data-name":!0,children:c}),o&&a.jsx("span",{"data-subtext":!0,children:o})]})]},`step-${s}`)})})]}):null}export{b as ProgressionStepper};
