import{u as E,r as g,v as F,w as O,j as a,x as S,y as $,f as w,B as l,s as B,n as P}from"./index-jcbivK3E.js";const h=document.createElement("style");h.appendChild(document.createTextNode(`[data-bspk=popover] {
  position: absolute;
...
`));document.head.appendChild(h);function q({placement:e="top",header:k,content:m,callToAction:t,secondaryCallToAction:o,children:v,disabled:z=!1,refWidth:b,...j}){var f,x,u;const n=E(),[i,d]=g.useState(!1),c=g.useRef(null),{elements:p,floatingStyles:y,middlewareData:r}=F({placement:e,strategy:"absolute",offsetOptions:22,arrowRef:c,hide:!i,refWidth:b});O({elements:[p.floating],callback:()=>d(!1),disabled:!i});const R=(f=r==null?void 0:r.arrow)!=null&&f.x?`${r.arrow.x}px`:"0px",C=()=>{var s;if((s=r==null?void 0:r.arrow)!=null&&s.x){if(e==="top-start"||e==="bottom-start")return"16px";if(e==="top"||e==="bottom")return`${r.arrow.x}px`;if(e==="top-end"||e==="bottom-end")return`${(r.arrow.x*2||32)-16}px`}return"0px"};return z?v({}):a.jsxs(a.Fragment,{children:[v({onClick:()=>d(!i),"aria-describedby":n}),i&&a.jsx(S,{children:a.jsx($.FocusTrap,{focusTrapOptions:{fallbackFocus:()=>p.floating||document.body,clickOutsideDeactivates:!0},children:a.jsxs("div",{"data-bspk":"popover","data-placement":(x=r==null?void 0:r.offset)==null?void 0:x.placement,id:n,ref:s=>{p.setFloating(s),p.setReference(document.querySelector(`[aria-describedby="${n}"]`))},style:{...y,...j.style},children:[a.jsxs("header",{children:[a.jsx(w,{variant:"heading-h6",children:k}),a.jsx(l,{"data-close":!0,icon:a.jsx(B,{}),iconOnly:!0,label:"Close",onClick:()=>d(!1),variant:"tertiary"})]}),a.jsxs("div",{"data-content":!0,children:[a.jsx(w,{as:"div",variant:"body-small",children:m}),a.jsxs("div",{"data-cta-row":!0,children:[(o==null?void 0:o.label)&&(o==null?void 0:o.onClick)&&a.jsx(l,{label:o.label,onClick:o.onClick,size:"small",variant:"secondary"}),(t==null?void 0:t.label)&&(t==null?void 0:t.onClick)&&a.jsx(l,{label:t.label,onClick:t.onClick,size:"small",variant:"primary"})]})]}),a.jsx("div",{"data-arrow":!0,ref:s=>{c.current=s},style:P({"--position-left":b?C():R,"--position-top":`${((u=r==null?void 0:r.arrow)==null?void 0:u.y)||0}px`})})]})})})]})}export{q as Popover};
