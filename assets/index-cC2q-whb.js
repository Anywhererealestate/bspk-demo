import{r as c,c as x,j as t,d as m}from"./index-BsfVAUQm.js";import{SvgKeyboardArrowUp as k}from"./KeyboardArrowUp-DCAdR3bW.js";const b=document.createElement("style");b.appendChild(document.createTextNode(`[data-bspk=accordion] {
  width: 100%;
...
`));document.head.appendChild(b);function w({items:l,singleOpen:g=!0}){const i=c.useMemo(()=>l.map(a=>({...a,id:a.id||`accordion-item-${x(8)}`})),[l]),[f,u]=c.useState(()=>i.filter(a=>a.isOpen).map(a=>a.id));c.useEffect(()=>{u(i.filter(a=>a.isOpen).map(a=>a.id))},[i]);const v=a=>()=>u(r=>{const n=r.includes(a);return g?n?[]:[a]:n?r.filter(o=>o!==a):[...r,a]});return t.jsx("div",{"data-bspk":"accordion",children:i.map(({children:a,title:r,subtitle:n,leading:o,trailing:p,disabled:d,id:e},h)=>{const s=f.includes(e);return t.jsxs("section",{"data-disabled":d||void 0,id:e,children:[t.jsxs("button",{"aria-controls":`${e}-content`,"aria-expanded":s,"data-header":!0,disabled:d||void 0,onClick:d?void 0:v(e),children:[o&&t.jsx("span",{"data-leading":!0,children:o}),t.jsxs("span",{"data-title-subtitle":!0,children:[t.jsx("span",{"data-title":!0,children:r}),n&&t.jsx("span",{"data-subtitle":!0,children:n})]}),p&&t.jsx("span",{"data-trailing":!0,children:p}),t.jsx("span",{"data-arrow":!0,children:s?t.jsx(k,{}):t.jsx(m,{})})]}),s&&t.jsx("div",{"data-content":!0,"data-hidden":!s||void 0,id:`${e}-content`,children:a}),t.jsx("span",{"data-divider":!0})]},e||h)})})}export{w as Accordion};
