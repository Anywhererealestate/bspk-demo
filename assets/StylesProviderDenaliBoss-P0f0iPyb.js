...
:root {
    ...
    --data-visual-category-01-highlight: #dae3e9;
    ...
    --data-visual-category-03-highlight: #dcd9e0;
...
[data-theme='dark'] {
    ...
    /* Data visual/category-01-highlight - Theme - Denali & Boss */
    --data-visual-category-01-highlight: #052336;
    /* Data visual/category-02 - Theme - Denali & Boss */
    ...
    /* Data visual/category-03-highlight - Theme - Denali & Boss */
    --data-visual-category-03-highlight: #0a001a;
    /* Data visual/category-04 - Theme - Denali & Boss */
...
`;function StylesProviderDenaliBoss(){const styleEmentRef=reactExports.useRef(null);return reactExports.useEffect(()=>(styleEmentRef.current=document.createElement("style"),styleEmentRef.current.setAttribute("data-bspk","denali-boss"),styleEmentRef.current.innerHTML=brandStyle+baseStyle,document.head.appendChild(styleEmentRef.current),document.body.style.display="",()=>{styleEmentRef.current&&document.head.removeChild(styleEmentRef.current)}),[]),jsx(Fragment,{})}StylesProviderDenaliBoss.bspkName="StylesProviderDenaliBoss";export{StylesProviderDenaliBoss};
