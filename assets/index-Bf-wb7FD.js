import{j as jsxRuntimeExports,h as CheckExports}from"./index-B6c-xvyP.js";const style=document.createElement("style");style.appendChild(document.createTextNode(`[data-bspk=progression-stepper] {
  width: 100%;
...
[data-bspk=progression-stepper][data-variant=widget] ol li [data-line-circle] [data-line] {
  width: 10px;
}
...
`));document.head.appendChild(style);function ProgressionStepper({steps=[],currentStep:currentStepProp=0,variant="horizontal",...containerProps}){const currentStep=Math.max(0,Math.min(currentStepProp,steps.length+1));return steps!=null&&steps.length?jsxRuntimeExports.jsxs("div",{...containerProps,"data-bspk":"progression-stepper","data-variant":variant,children:[variant==="widget"&&jsxRuntimeExports.jsxs("label",{children:[jsxRuntimeExports.jsx("span",{"data-title":!0,children:steps[Math.max(0,Math.min(currentStep-1,steps.length-1))].name}),jsxRuntimeExports.jsx("span",{"data-subtitle":!0,children:currentStep>=steps.length?"Completed":jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment,{children:["Step ",currentStep," of ",steps.length]})})]}),jsxRuntimeExports.jsx("ol",{children:steps.flatMap(({name,subtext},index)=>{const stepNum=index+1;let status="incomplete";return stepNum<currentStep?status="complete":stepNum===currentStep&&(status="current"),jsxRuntimeExports.jsxs("li",{"data-status":status,"data-step":stepNum,children:[jsxRuntimeExports.jsxs("span",{"aria-hidden":!0,"data-line-circle":!0,children:[jsxRuntimeExports.jsx("span",{"data-line":"before"}),jsxRuntimeExports.jsxs("span",{"data-circle":!0,children:[jsxRuntimeExports.jsx("span",{children:stepNum}),status==="complete"&&jsxRuntimeExports.jsx(CheckExports.SvgCheck,{})]}),jsxRuntimeExports.jsx("span",{"data-line":"after"})]}),variant!=="widget"&&jsxRuntimeExports.jsxs("span",{"data-content":!0,children:[jsxRuntimeExports.jsx("span",{"data-name":!0,children:name}),subtext&&jsxRuntimeExports.jsx("span",{"data-subtext":!0,children:subtext})]})]},`step-${index}`)})})]}):null}ProgressionStepper.bspkName="ProgressionStepper";export{ProgressionStepper};
